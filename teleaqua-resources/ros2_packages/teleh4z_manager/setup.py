...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'joystick_mapper = teleh4z_manager.joystick_mapper:main',
            'manual_water_thruster_mapper = teleh4z_manager.manual_water_thruster_mapper:main',
            ...
            'z_axis_cross_domain_runner = teleh4z_manager.z_axis_cross_domain_runner:main',
        ],
    },
)
